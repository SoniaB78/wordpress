<?php
/*Ce fichier fait partie deSketchEnfant, sketch child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function SketchEnfant_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'SketchEnfant_enqueue_child_styles' );
